...
export function Home() {
  return (
    <div className={styles['homepage']}>
      ...
      <p>Для добавления отрезка, кликните на точку, чтобы зафиксировать начальну точку отрезка. Затем установите конечную точку отрезка. Чтобы добавить точку на плоскость, нужно кликнуть в произвольное место плоскости. Точки и отрезки можно удалять двойным кликом.</p>
    </div>
  );
}
